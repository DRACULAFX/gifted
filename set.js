...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~iqQgEZIB#zpUR9ssccjGCPQC5XD1zbQSzqIj9aBEE1Qbmezj7c-c", // Add sess Id here especially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "2349060853189", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "2348026052164", // Only 1 owner Number Here, others Add to sudo numbers...
